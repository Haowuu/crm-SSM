...
import com.wh.crm.workbench.domain.ContactsActivityRelation;
...
public interface ContactsActivityRelationMapper {
    ...
    int saveContactsActivityRelation(List<ContactsActivityRelation> contactsActivityRelationList);
}