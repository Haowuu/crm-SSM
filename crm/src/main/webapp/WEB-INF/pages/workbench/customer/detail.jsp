...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#saveCreateCustomerRemarkBtn").click(function () {
			var remarkNoteContent = $.trim($("#remark").val());
			if (remarkNoteContent == "") {
				alert("请填写备注");
				return;
			}
			$.ajax({
				...
				success: function (data) {
					if (data.code == '1') {
						...
						html+='<font color="gray">客户</font> <font color="gray">-</font> <b>${requestScope.customer.name}</b> <small style="color: gray;">'+data.returnData.createTime+'  由${sessionScope.sessionUser.name}创建</small>'
...
<body>
	...
	<div style="position: relative; top: 10px; left: 40px;">
		...
		<c:forEach items="${requestScope.customerRemarkList}" var="remark">
			<div class="remarkDiv" style="height: 60px;">
				<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>${remark.noteContent}</h5>
					<font color="gray">客户</font> <font color="gray">-</font> <b>${requestScope.customer.name}</b> <small style="color: gray;"> ${remark.editFlag==1?remark.editTime:remark.createTime} 由${remark.editFlag==1?remark.editBy:remark.createBy}${remark.editFlag==1?"修改":"创建"}</small>
		...
		<div style="position: relative; top: 20px; left: 40px;">
			...
			<div style="position: relative;top: 0px;">
				<table id="activityTable2" class="table table-hover" style="width: 900px;">
					...
					<tbody>
					<c:forEach items="${requestScope.transactionList}" var="tran">
						<tr>
